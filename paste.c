...
void option_d(int file_num, char **file_list, bool *is_file_end_list, FILE **file_list_pointer, int d_param_num) {
...
int main(int argc, char *argv[]) {
  ...
  printf("dparam_numは%d\n", d_param_num); 
  if(dopt) option_d(file_num, file_list, is_file_end_list, file_list_pointer, d_param_num);
